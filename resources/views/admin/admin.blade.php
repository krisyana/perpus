          ...
          <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
            ...
            <div class="card card-cascade cascading-admin-card">
              ...
              <div class="admin-up">
                ...
                <div class="data">
                  <p class="text-uppercase">Peminjaman</p>
              ...
              <div class="card-body card-body-cascade">
                ...
                <p class="card-text">lebih Baik (25%)</p>
              </div>
          ...
          <div class="col-xl-3 col-md-6 mb-xl-0 mb-4">
            ...
            <div class="card card-cascade cascading-admin-card">
              ...
              <div class="admin-up">
                ...
                <div class="data">
                  <p class="text-uppercase">Pendaftaran</p>
                  <h4 class="font-weight-bold dark-grey-text">3</h4>
                </div>
              </div>
              ...
              <div class="card-body card-body-cascade">
                ...
                <p class="card-text">Lebih buruk (25%)</p>
              </div>
          ...
          <div class="col-xl-3 col-md-6 mb-md-0 mb-4">
            ...
            <div class="card card-cascade cascading-admin-card">
              ...
              <div class="admin-up">
                ...
                <div class="data">
                  <p class="text-uppercase">Pengembalian</p>
              ...
              <div class="card-body card-body-cascade">
                ...
                <p class="card-text">Lebih baik (75%)</p>
              </div>
          ...
          <div class="col-xl-3 col-md-6 mb-0">
            ...
            <div class="card card-cascade cascading-admin-card">
              ...
              <div class="admin-up">
                ...
                <div class="data">
                  <p class="text-uppercase">Belum Dikembalikan</p>
                  <h4 class="font-weight-bold dark-grey-text">3</h4>
                </div>
              </div>
            ...
            <div class="row">
              ...
              <div class="col-xl-5 col-lg-12 mr-0 pb-2">
                ...
                <div class="view view-cascade gradient-card-header light-blue lighten-1">
                  <h2 class="h2-responsive mb-0 font-weight-500">Peminjaman</h2>
                </div>
                ...
                <div class="card-body card-body-cascade pb-0">
                  ...
                  <div class="row py-3 pl-4">
                    ...
                    <div class="col-md-6 text-center pl-xl-2 my-md-0 my-3">
                      ...
                      <!-- Summary -->
                      <p>Total peminjaman: <strong>20</strong>
                      ...
                      <p>Total Pengembalian: <strong>3</strong>
          ...
          <section>
            ...
            <div class="card card-cascade narrower z-depth-0">
              ...
              <div
                ...
                <a href="" class="white-text mx-3">Tabel Member</a>
